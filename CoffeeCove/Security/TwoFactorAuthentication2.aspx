<%@ Page Title="2-Factor Authentication" Language="C#" 
    ...
    CodeBehind="TwoFactorAuthentication2.aspx.cs" 
    Inherits="CoffeeCove.Security.TwoFactorAuthentication2" %>
...
<div class="max-w-md mx-auto p-6 bg-card rounded-lg shadow-md">
    ...
    <div class="relative mb-4">
        ...
        <asp:RequiredFieldValidator 
            ID="otp_tfa2_rqdValidator" 
            runat="server" 
            ControlToValidate="otp_tfa2" 
            ErrorMessage="OTP is required." 
            Display="Dynamic" 
            ForeColor="Red" 
            CssClass="rqdValidator" />
        <asp:RegularExpressionValidator 
            ID="otp_tfa2_regexValidator" 
            runat="server" 
            ControlToValidate="otp_tfa2" 
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function () {
        var passwordField = document.getElementById("<%= otp_tfa2.ClientID %>");
